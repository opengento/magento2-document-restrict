...
namespace Opengento\DocumentRestrict\Ui\DataProvider\Restrict\Form;
...
final class DataProvider extends AbstractDataProvider
{
    ...
    private function resolveDataSource(array $dataSource): array
    {
        ...
        if ($this->dataPersistor->get('document_restrict_post_data')) {
            $postData = $this->dataPersistor->get('document_restrict_post_data') ?? [];
